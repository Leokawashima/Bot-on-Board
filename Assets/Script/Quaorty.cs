...
public class Quaorty : MonoBehaviour
{
    ...
    {
        if(!Directory.Exists(Name.Setting.ScreenShotFilePath))
        {
            Directory.CreateDirectory(Name.Setting.ScreenShotFilePath);
        }
        ...
        ScreenCapture.CaptureScreenshot(Name.Setting.ScreenShotFilePath + $"/{photoname}.png");
    }
}