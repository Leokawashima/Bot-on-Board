...
namespace ProPixelizer
{
    ...
    public class ProPixelizerVerification
    {
        ...
        {
#if UNITY_EDITOR
            AssetDatabase.ImportAsset("Assets/Downloads/ProPixelizer/ShaderGraph/ProPixelizerBase.shadergraph", ImportAssetOptions.ForceUpdate);
            AssetDatabase.ImportAsset("Assets/Downloads/ProPixelizer/SRP/PixelizedWithOutline.shader", ImportAssetOptions.ForceUpdate);
#endif
        }
